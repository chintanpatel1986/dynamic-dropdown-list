...
import org.chintanpatel.app.domain.College;
...
public class CollegeDao {
    ...
    // Create insert method for adding college records into the database.
    ...
    // Create List method for fetching college records from the database.
    ...
    // Create find method for fetching single record from the database.
    ...
    // Create method for updating college record and store it back to database.

    public boolean updateCollege(College college) {
        boolean flag = false;
        try (Connection conn = DBConnection.getConnection();
        PreparedStatement pstmt = conn.prepareStatement("update tbl_college set college_name=? where college_id=?"))
        {
                pstmt.setString(1, college.getCollegeName());
    ...
    // Create method for deleting single college record from the database.
