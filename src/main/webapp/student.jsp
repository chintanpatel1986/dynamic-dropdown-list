...
<%@ page import="org.chintanpatel.app.domain.College" %><%--
...
<div class="container mt-5 border border-1">
    <div class="container">
        ...
        <form action="StudentController" method="post" class="row g-3">
            ...
            <div class="col-4">
                <label class="form-label fw-bold">MiddleName</label>
            ...
            <div class="col-12">
                ...
                <textarea name="address" class="form-control" rows="5" cols="38">${student.address}</textarea>
            </div>
            <div class="col-6">
                ...
                <tbody>
                    <c:forEach items="${studentList}" var="student">
                        <tr>
                            ...
                            <td>
                                <a href="StudentController?action=edit&studentId=${student.studentId}" class="link-success">Edit</a>
                                &nbsp;|&nbsp;
